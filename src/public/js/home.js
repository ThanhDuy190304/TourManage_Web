document.addEventListener('DOMContentLoaded', () => {
    ...
    // Tạo HTML cho phản hồi từ khách hàng
    ...
    // Assuming you have a button to trigger the clickButton function
    const loginButton = document.getElementById('loginButton'); // Adjust the ID as needed
    if (loginButton) {
